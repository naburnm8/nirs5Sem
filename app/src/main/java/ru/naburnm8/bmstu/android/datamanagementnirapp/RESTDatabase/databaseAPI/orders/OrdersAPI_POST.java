...
public class OrdersAPI_POST extends AsyncTask<Void, Void, OrdersResponse> {
    ...
    public OrdersAPI_POST(RESTDBOutput context, String baseUrl, Orders object, String token) {
    ...
    protected OrdersResponse doInBackground(Void... voids) {
        try{
            Call<Orders> call = apiService.createOrder("Bearer " + token, object);
            ...
            lastLog = e.toString();
            Log.println(Log.ERROR, "OrdersAPI_POST", e.toString());
        }
        return null;
    }
