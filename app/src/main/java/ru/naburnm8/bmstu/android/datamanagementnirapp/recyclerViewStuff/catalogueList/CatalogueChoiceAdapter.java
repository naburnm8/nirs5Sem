...
public class CatalogueChoiceAdapter extends RecyclerView.Adapter<CatalogueChoiceAdapter.CatalogueViewHolder> {
    private final OnDBandRecyclerListener context;
    private final ArrayList<Catalogue> catalogueArrayList;

    public CatalogueChoiceAdapter(ArrayList<Catalogue> catalogueArrayList, OnDBandRecyclerListener context) {
    ...
    public class CatalogueViewHolder extends RecyclerView.ViewHolder{
        ...
        public void bind(final Catalogue catalogue){
            ...
            deleteButton.setText(R.string.chooseThis);
