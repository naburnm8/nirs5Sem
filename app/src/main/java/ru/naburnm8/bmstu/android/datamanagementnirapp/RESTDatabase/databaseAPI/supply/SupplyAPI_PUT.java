...
public class SupplyAPI_PUT extends AsyncTask<Void, Void, SupplyResponse> {
    ...
    public SupplyAPI_PUT(RESTDBOutput context, String baseUrl, Supply object, String token) {
    ...
    protected SupplyResponse doInBackground(Void... voids) {
        try{
            Call<Supply> call = apiService.updateSupply("Bearer " + token, object.getId(), object);
            ...
            lastLog = e.toString();
            Log.println(Log.ERROR, "SupplyAPI_PUT", e.toString());
        }
        return null;
    }
